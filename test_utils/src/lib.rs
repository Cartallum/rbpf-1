...
impl cbe_rbpf::verifier::Verifier for TautologyVerifier {
    fn verify(
        _prog: &[u8],
        _config: &cbe_rbpf::vm::Config,
        _function_registry: &cbe_rbpf::vm::FunctionRegistry,
    ) -> std::result::Result<(), cbe_rbpf::verifier::VerifierError> {
        Ok(())
    }
}
