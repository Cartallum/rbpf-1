...
///
/// ```
/// use cbe_rbpf::syscalls::bpf_trace_printf;
/// use cbe_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use cbe_rbpf::vm::{Config, ProgramResult, TestContextObject};
///
...
///
/// ```
/// use cbe_rbpf::syscalls::bpf_gather_bytes;
/// use cbe_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use cbe_rbpf::vm::{Config, ProgramResult, TestContextObject};
///
/// let mut result = ProgramResult::Ok(0);
...
///
/// ```
/// use cbe_rbpf::syscalls::bpf_mem_frob;
/// use cbe_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use cbe_rbpf::vm::{Config, ProgramResult, TestContextObject};
///
...
///
/// ```
/// use cbe_rbpf::syscalls::bpf_str_cmp;
/// use cbe_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use cbe_rbpf::vm::{Config, ProgramResult, TestContextObject};
///
