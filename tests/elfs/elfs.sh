...
# Requires Latest release of Cartallum CBE's custom LLVM
#https://github.com/Cartallum/llvm-builder/releases

LLVM_DIR=../../../cbc-testnet/sdk/sbf/dependencies/sbf-tools/llvm/bin/
