        ...
        #[cfg(all(not(windows), target_arch = "x86_64"))]
        {
            ...
            match compilation_result {
                ...
                Ok(()) => {
                    ...
                    {
                        let analysis = cbe_rbpf::static_analysis::Analysis::from_executable(
...
fn test_reloc_64_relative_data_pre_sbfv2() {
    // Before https://github.com/Cartallum/llvm-project/pull/35, we used to
...
fn execute_generated_program(prog: &[u8]) -> bool {
    ...
    let verified_executable = VerifiedExecutable::<
        cbe_rbpf::verifier::RequisiteVerifier,
        TestContextObject,
